...
impl Lit {
    ...
    #[requires(self.invariant((@a).len()))]
    #[ensures(result == !self.unset(*a))]
    pub fn lit_set(self, a: &Assignments) -> bool { a.0[self.idx] < 2 }
    ...
    pub fn to_watchidx(&self) -> usize { self.idx * 2 + if self.polarity { 0 } else { 1 } }
    ...
    pub fn to_neg_watchidx(&self) -> usize { self.idx * 2 + if self.polarity { 1 } else { 0 } }
}
...
impl PartialEq for Lit {
    ...
    //#[ensures(result == (*self == *other))] // :(
    fn eq(&self, other: &Lit) -> bool { self.idx == other.idx && self.polarity == other.polarity }
}
...
impl ops::Not for Lit {
    ...
    fn not(self) -> Lit { Lit { idx: self.idx, polarity: !self.polarity } }
}
